          ...
          <StyledContainer>
            ...
            <StyledDataItem>
              <StyledSubContainer>
                ...
                11. В розгорнутому проекті в шапці має бути ім'я та прізвище студента.<br /><br />

                Документація:<br />
                12. Документація на проект (діаграма архітектури, діаграма використаної інфраструктури)<br />
                13. Декомпозиція задач проекту (список завдань та підзавдань проекту)<br />
                14. В проекті має бути сторінка About з таким переліком інформації:<br />
                Прізвище та Ім'я студента<br />
                Назва проекту<br />
                Посилання на Телеграм (лінка по якій можна перейти і одразу написати студенту)<br />
                Email студента<br />
                Посилання на Github репозиторій де зберігається код проекту<br />
                15. В проекті має бути файл Readme з таким переліком інформації:<br />
                Як запустити проект?<br />
                Які технології\пакети використовуються і для чого? (Entity Framework, Swashbuckle, MS Test...)<br />
                Як ресурси використовує проект ? (Sql Database, Azure App Service...)<br />
                Документація на проект (діаграма архітектури, діаграма використаної інфраструктури)<br />
                Декомпозиція задач проекту (список завдань та підзавдань проекту)<br />
                Прізвище та Ім'я студента<br />
                Назва проекту<br />
                Посилання на Телеграм (лінка по якій можна перейти і одразу написати студенту)<br />
                Email студента<br />
                Посилання на задеплоєний проект Azure/AWS<br /><br />

                Тестування:<br />
                16. Postman колекції для тестування 5ти сценаріїв<br />
                17. Unit тести алгоритму обробки даних<br /><br />
